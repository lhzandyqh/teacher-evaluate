<template>
  <div class="appcontainer">
    ...
    <el-dialog :visible.sync="dialogFormVisible" title="艺科体社团情况">
      <el-form ref="form" :model="form" label-width="100px">
        <el-form-item label="比赛类别">
          <el-select v-model="form.region" placeholder="请选择比赛类别">
        ...
        <el-form-item label="获奖名称">
          <el-input v-model="form.huoname"/>
        </el-form-item>
        <el-form-item label="获奖级别">
          <el-select v-model="form.jibie" placeholder="请选择获奖级别">
